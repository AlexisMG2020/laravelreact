...
<tr>
            <td>
                <div className="form-group form-check">
                    <input type="checkbox" className="form-check-input" id="Miercoles" defaultChecked={formulario.dias_asignados.includes('Miercoles')} onClick={clicDia} />
            ...
            <td>
                <Form.Control
                    ...
                    min="07:00"
                    max="21:00"
                    disabled={!formulario.dias_asignados.includes('Miercoles')}
                    className="form-control form-control-sm" 
                />
            </td>
            <td>
...
<tr>
            <td>
                <div className="form-group form-check">
                    <input type="checkbox" className="form-check-input" id="Sabado" defaultChecked={formulario.dias_asignados.includes('Sabado')} onClick={clicDia} />
            ...
            <td>
                <Form.Control
                    ...
                    min="07:00"
                    max="21:00"
                    disabled={!formulario.dias_asignados.includes('Sabado')}
                    className="form-control form-control-sm" 
                />
            </td>
            <td>
